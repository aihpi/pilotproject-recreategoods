...
python train_curriculum.py --config configs/example_curriculum.yaml
...
python train_curriculum.py --config my_config.yaml
```

This approach is much cleaner and easier to manage for complex training runs.